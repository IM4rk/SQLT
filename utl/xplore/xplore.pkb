...
/* $Header: xplore/xplore.pkb 12.1.08 2014/04/18 carlos.sierra mauro.pagano $ */
   ...
   *
   * ------------------------- */
  TOOL_VERSION         CONSTANT VARCHAR2(32)  := '12.1.08';
  ...
  COPYRIGHT            CONSTANT VARCHAR2(128) := 'Copyright (c) 2000-2014, Oracle Corporation. All rights reserved.';
