...
/* $Header: 215187.1 sqcpkga.pkb 12.1.160429 2016/04/29 carlos.sierra mauro.pagano abel.macias@oracle.com $ */
...
-- 141028 removed parameters from pq_tqstat
  ...
  BEGIN
    ...
    -- possible remap
    -- 22170172
    l_schema_owner := NVL(TRIM(DBMS_ASSERT.QUALIFIED_SQL_NAME(p_schema_owner)), 'NULL'); -- NULL means no remap
