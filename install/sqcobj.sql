...
REM
REM $Header: 215187.1 sqcobj.sql 12.1.12 2015/09/11 carlos.sierra mauro.pagano abel.macias@oracle.com $ 
REM
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$im_segments ADD (owner                     VARCHAR2(128));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$im_segments ADD (segment_name              VARCHAR2(128));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$im_segments ADD (partition_name            VARCHAR2(128));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$im_segments ADD (segment_type              VARCHAR2(18));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$im_segments ADD (tablespace_name           VARCHAR2(30));
...
ALTER TABLE &&tool_repository_schema..sqlt$_gv$im_column_level ADD (owner                   VARCHAR2(31));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$im_column_level ADD (obj_num                 NUMBER);
ALTER TABLE &&tool_repository_schema..sqlt$_gv$im_column_level ADD (table_name              VARCHAR2(31));
ALTER TABLE &&tool_repository_schema..sqlt$_gv$im_column_level ADD (segment_column_id       NUMBER);
ALTER TABLE &&tool_repository_schema..sqlt$_gv$im_column_level ADD (column_name             VARCHAR2(31));
...
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_plan_dir_objs ADD (owner            VARCHAR2(128));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_plan_dir_objs ADD (object_name      VARCHAR2(128));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_sql_plan_dir_objs ADD (subobject_name   VARCHAR2(128));
...
-- GV$SQL_PLAN, DBA_HIST_SQL_PLAN, DBA_SQLTUNE_PLANS
ALTER TABLE &&tool_repository_schema..sqlt$_display_map ADD (source          VARCHAR2(30));
...
CREATE GLOBAL TEMPORARY TABLE &&tool_repository_schema..sqlg$_pivot (
  ...
  parent_table_owner         VARCHAR2(30),
  obj#                       NUMBER,
  dataobj#                   NUMBER
) ON COMMIT PRESERVE ROWS;
