...
/* $Header: 215187.1 sqcpkgr.pkb 12.1.160429 2016/04/29 carlos.sierra mauro.pagano abel.macias@oracle.com $ */
  ...
  BEGIN
    ...
    LOOP
      ...
      PIPE ROW(RPAD(i.status, 8)||RPAD(i.object_type, 13)||RPAD(l_line_text, 14)||i.object_name);
    END LOOP;
