...
/* $Header: 215187.1 sqcpkgi.pkb 12.1.160429 2016/04/29 carlos.sierra mauro.pagano abel.macias@oracle.com $ */
      ...
      ELSE -- it was executed by XTRACT or XECUTE, or if it was by XPLAIN and the sqltext was found in memory or AWR
        BEGIN
         ...
         'BEGIN SYS.DBMS_SQLDIAG.EXPORT_SQL_TESTCASE ( '||
            ...
            (case when sqlt$a.get_param('tcb_export_pkg_body')='TRUE' and sqlt$a.get_rdbms_version >= '11.2' then 'exportPkgbody => TRUE, ' end)||
